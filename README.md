...
コピーしたパスのユーザー名を匿名化してクリップボードに戻す CLI ツールです。
...
2. お使いの OS に合わせた ZIP ファイルをダウンロードしてください。
   - Windows: `pathmask-windows-amd64.zip`
   - Mac (arm): `pathmask-mac-arm64.zip`
   - Mac (x86): `pathmask-mac-amd64.zip`
...
また、標準入力による変換にも対応しています

例
```
PS C:\Users\tarou> where.exe python | pathmask
C:\Users\[USER]\AppData\Local\Programs\Python\Python313\python.exe
C:\Users\[USER]\AppData\Local\Microsoft\WindowsApps\python.exe
```
この場合、クリップボードの中身は編集しません
